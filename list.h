...
extern NodePosition List_find( List list, void* element, int (*compare)(const void*, const void*) );
...
extern void List_push_back( List list, void* element, void (*assign)(void*, const void*) );
